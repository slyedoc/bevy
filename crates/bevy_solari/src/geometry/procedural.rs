...
/// through [`GpuRetire`]) — avoids per-batch allocation churn.
        ...
        for cluster in clusters.iter() {
            descriptors.push(
                vk::ClusterAccelerationStructureBuildTriangleClusterTemplateInfoNV {
                    ...
                    // 0 = no instantiation bbox clamp. A nonzero limit here
                    // (band AABB) hangs the GPU on the first traced frame — the
                    // driver appears to bake it against the reference geometry.
