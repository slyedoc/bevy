...
///
/// The material used for this entity must be [`MeshMaterial3d<StandardMaterial>`] or
/// [`MeshMaterial3d<ExtendedMaterial<StandardMaterial, E>>`] (registered via [`SolariMaterialApp::add_solari_material`]).
